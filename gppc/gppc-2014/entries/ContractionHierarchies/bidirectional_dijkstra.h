...
private:
	...
	int best_distance;
public:
	Dijkstra<Flags, ForwardAdjGraph>forward;
	Dijkstra<Flags, BackwardAdjGraph>backward;

	BidirectionalDijkstra(const ForwardAdjGraph&forward, const BackwardAdjGraph&backward):
		forward(forward),
		backward(backward){
...
BidirectionalDijkstra<Flags, ForwardAdjGraph, BackwardAdjGraph>make_bidirectional_dijkstra(const ForwardAdjGraph&forward, const BackwardAdjGraph&backward){
	return BidirectionalDijkstra<Flags, ForwardAdjGraph, BackwardAdjGraph>(forward, backward);
}
